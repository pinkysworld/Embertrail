...
export type AttributeId = "cou" | "cle" | "int" | "cha" | "dex" | "agi" | "con" | "str";
export type NegativeTraitId = "superstition" | "acrophobia" | "claustrophobia" | "avarice" | "necrophobia" | "curiosity" | "violentTemper";
export type ArchetypeId = "steelguard" | "seafarer" | "stonekin" | "shadowhand" | "trickster" | "hexweaver" | "wildcaller" | "magister" | "pathfinder" | "leafborn" | "grovekin" | "frostborn";
export type SkillCategory = "combat" | "body" | "social" | "lore" | "craft" | "nature" | "perception";
export type MagicSchool = "elemental" | "healing" | "illusion" | "mind" | "nature" | "battle";
...
export type ServerMessage = {
    ...
    type: "notification";
    kind: "info" | "warn" | "loot" | "skill" | "quest";
    textKey: string;
...
export declare const PORTS: {
    readonly client: 5173;
    readonly server: 2567;
    readonly api: 3000;
};
export declare const MAX_PARTY = 6;
export declare const HUB_SOFT_CAP = 50;
